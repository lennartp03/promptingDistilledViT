...
class Convpass(nn.Module):
    def __init__(self, adapt_dim=192, dim=8, xavier_init=False, distilled=None):
        ...
        self.adapter_down = nn.Linear(adapt_dim, dim) #768 für ViT zu 192 für Deitd  # equivalent to 1 * 1 Conv
        self.adapter_up = nn.Linear(dim, adapt_dim)  # equivalent to 1 * 1 Conv
    ...
    def forward(self, x):
        ...
        x_patch = x_down[:, sliced_token:].reshape(B, 14, 14, self.dim).permute(0, 3, 1, 2) # IMG Patches 16 statt 14 bei Deit
